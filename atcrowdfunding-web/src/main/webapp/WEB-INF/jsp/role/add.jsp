        ...
        <script type="text/javascript">
            $(function () {
			    ...
			    $("#insertBtn").click(function(){
			    	var name = $("#name").val();
			    	if ( name == "" ) {
                        layer.msg("职位名称不能为空，请输入", {time:2000, icon:5, shift:6}, function(){
			    	...
			    	$.ajax({
			    		...
			    		success : function(result) {
			    			...
			    			if ( result.success ) {
		                        layer.msg("职位名称保存成功", {time:1000, icon:6}, function(){
		                        	window.location.href = "${APP_PATH}/role/index";
		                        });
			    			} else {
		                        layer.msg("职位名称保存失败，请重新操作", {time:2000, icon:5, shift:6}, function(){
